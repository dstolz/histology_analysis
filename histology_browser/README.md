...
are paired into ROIs, the ROI encode/decode round trip, profile measurement, and the
values-CSV round trip against synthetic inputs, then builds a catalog and drives a live
browser through filtering, selection, ROI naming, and the ROI add / edit / save / revert
cycle.
