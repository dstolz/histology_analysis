...
obj.EditRoiButton.Tooltip = "Drag the line ROI of the marked section. " ...
...
obj.DrawRoiButton.Tooltip = "Drag on the marked section to place a new line at " ...
    + "the width above." + obj.shortcutHint("drawRoi");
...
obj.ShowBandGridCheck.Tooltip = "Rule the sampling band parallel and square to the " + ...
    "line, to check it against a layer boundary. Needs the band itself shown.";
