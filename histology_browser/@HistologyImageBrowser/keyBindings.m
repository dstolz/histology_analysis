...
bindings = add(bindings, "e", ["control", "shift"], "nextRoi", ...
    "Line ROI", "Move to this section's next ROI");
bindings = add(bindings, "e", "control", "toggleEditRoi", ...
    "Line ROI", "Start or finish editing the chosen ROI");
bindings = add(bindings, "d", "control", "drawRoi", ...
    "Line ROI", "Draw a new line over the image");
...
bindings = add(bindings, "f", ["control", "shift"], "openFolder", ...
    "Display", "Open the folder holding the selected image");
